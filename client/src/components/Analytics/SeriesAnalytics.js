...
const SeriesAnalytics = ({ timeSpentWatchingSeries }) => {
      ...
      {displayMode === "graphs" ? (
        <>
                ...
                <Grid item xs={12} sm={6} md={6} lg={6}>
                  ...
                  <PieChart width={500} height={300}>
                    <Pie
                      ...
                      label
                    >
                      {timeSpentWatchingSeries?.map((entry, index) => (
          ...
          {chartMode === "stacked" && (
            ...
            >
              ...
              <BarChart width={500} height={300} data={timeSpentWatchingSeries}>
                <CartesianGrid
                  strokeDasharray="3 3"
                  stroke={generateRandomColor()}
                />
        ...
        >
          ...
          >
            ...
            >
              {timeSpentWatchingSeries?.map((dataPoint, index) => (
                <TableRow
                  style={{
                    color: generateRandomColor(),
                    border: `1px solid ${generateRandomColor()}`,
